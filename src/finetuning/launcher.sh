...
#SBATCH --output=/home/bsc/bsc048726/politics/new_cmp_encoder/results/finetuning/slurm_out/train_%j.out
#SBATCH --error=/home/bsc/bsc048726/politics/new_cmp_encoder/results/finetuning/slurm_out/train_%j.err
#SBATCH --ntasks=1
...
python3 -u "$exec_file" --epochs ${NUM_EPOCHS} --print-graphs --lr ${LR} --bs ${BATCH_SIZE} --data-path ${data_path} --train-file-name ${train_file_name}> $RESULTSDIR/${TYPE}_${model}_epochs_${NUM_EPOCHS}_gpus_${GPUS}_${perc}.out

...
class Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, df:pd.DataFrame, tokenizer:BertTokenizer, labels_dict:dict):
...
def print_results(train_acc:np.array, train_loss:np.array, val_acc:np.array, val_loss:np.array, save_path:str, title:str=""):
    """
    ...
    plt.savefig(save_path+"accuracy_losses.png", bbox_inches='tight', dpi=300)
    plt.show()
